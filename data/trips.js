...
window.TRIPS = [
{
  ...
  "weather": [
    "三月早晚仍涼，準備可增減的外套與雨具。",
    "海港與犬山戶外行程注意風勢；不要預設 3/9–3/14 已到櫻花滿開期。"
  ],
  "info": [
    {
      "title": "🎟️ 門票與預約",
      "items": [
        "樂高樂園先查 2027/3/11 營業日與適用票種。",
        "馬喰一代、花岡確認分店、用餐時段與訂位方式。",
        "水族館活動依當日場次；犬山城預留步行與登城時間。"
      ]
    },
    {
      "title": "🧳 抵達與返程",
      "items": [
        "3/9 13:55 抵達後先入境、搭名鐵至市區與寄放行李。",
        "3/14 19:40 起飛，博物館與午餐後取回行李再去機場。",
        "名古屋車站有多家鐵路，機場列車請找「名鐵」指標。"
      ]
    },
    {
      "title": "🍜 用餐提醒",
      "items": [
        "山本屋總本家「本家」目前週二、週三休息，首日晚餐先核對分店。",
        "Tsubame 早餐品項有供應時段，週六保留候位時間。",
        "返程日麵家獅子丸若排隊過久，優先保留機場交通時間。"
      ]
    }
  ],
  "notes": [
    "景點座標為地圖代表點，導航時以實際入口為準。",
    "推薦文可參考餐點與遊覽體驗，舊價格與店休以店家最新公告為準。"
  ]
},
{
  "id": "hokkaido-2027",
