...
window.TRIPS = [
  {
    ...
    days: [
      ...
      },
      {
        ...
        items: [
          { time: "早上", text: "仙台搭 E5 やまびこ → 福島站(約 25 分)" },
          { time: "上午", text: "Marusei 果樹園採水蜜桃!8 月白桃盛產期,現採現吃超甜" },
          { time: "下午", text: "返仙台途中順遊金蛇水神社(岩沼)祈財運・蛇紋石打卡" },
          { time: "晚餐", text: "燒肉仔虎(仙台牛名店)" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "warn", title: "務必提前預約", text: "Marusei 果樹園採果旺季務必預約!返仙台途中在岩沼站下車轉乘前往金蛇水神社,車程約 20 分再轉車。" }
      },
      {
