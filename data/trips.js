...
window.TRIPS = [
  {
    ...
    days: [
      ...
      {
        day: 2, date: "8/22 (六)", theme: "🚤 岩手・松島 — 猊鼻溪 + 遊覽船",
        items: [
          { time: "早餐", text: "仙台朝市(仙台站西口步行約 5 分)" },
          { time: "上午", text: "猊鼻溪舟遊(¥2,000,來回約 90 分)奇岩峭壁、船夫民謠吟唱、小鴨隨行" },
          { time: "下午", text: "松島遊覽船(日本三景之一,環灣約 50 分)" },
          { time: "晚餐", text: "大魔王 GOLD 居酒屋" },
          { time: "逛", text: "仙台 PARCO(寶可夢中心、UNIQLO)" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "warn", title: "注意船班", text: "一天排猊鼻溪+松島兩段船,務必先查時刻:猊鼻溪末班船約 15:00(TEL +81-191-47-2341),松島遊覽船末班約 15:00–16:00。" }
      },
      {
        day: 3, date: "8/23 (日)", theme: "🚄 秋田一日 — 盛岡・角館・田澤湖", couple: true,
        items: [
          { time: "早上", text: "仙台搭 E5 → 盛岡站,月台看 E5/E6 連結・分離奇景!往秋田的こまち與往青森的はやぶさ在此合體分離" },
          { time: "上午", text: "角館武家屋敷散策(盛岡搭 E6 こまち約 45 分)江戶黑圍牆武士老街" },
          { time: "午餐", text: "櫻之里(角館・比內地雞親子丼)" },
          { time: "下午", text: "田澤湖環湖巴士(¥1,210)辰子像打卡・日本最深湖的湛藍湖水" },
          { time: "晚餐", text: "白雞舍拉麵" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "info", title: "小提醒", text: "角館 → 田澤湖新幹線僅 15 分;環湖巴士班次不多,抵達後先確認回程時刻。" }
      },
      {
        day: 4, date: "8/24 (一)", theme: "🍑 福島 — Marusei 採水蜜桃 + 麵包超人博物館",
        items: [
          { time: "早上", text: "仙台搭 E5 やまびこ → 福島站(約 25 分)" },
          { time: "上午", text: "Marusei 果樹園採水蜜桃!8 月白桃盛產期,現採現吃超甜" },
          { time: "下午", text: "返仙台,麵包超人兒童博物館(10:00–17:00)角色麵包・舞台表演・戶外水上遊樂" },
          { time: "晚餐", text: "燒肉仔虎(仙台牛名店)" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "warn", title: "務必提前預約", text: "Marusei 果樹園採果旺季務必預約!麵包超人博物館建議購 Klook 套票。" }
      },
      {
        day: 5, date: "8/25 (二)", theme: "⛩ 仙台近郊 — 金蛇水神社・水族館・Outlet",
        items: [
          { time: "早上", text: "金蛇水神社(岩沼)祈財運・蛇紋石打卡" },
          { time: "下午", text: "仙台海洋森林水族館(9:00–17:30)沙丁魚旋風秀・企鵝大遊行" },
          { time: "傍晚", text: "三井 Outlet 仙台港(10:00–20:00)東北最大 Outlet,步行 10 分即達" },
          { time: "晚餐", text: "閣牛舌(牛たん料理 閣)" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "info", title: "小提醒", text: "金蛇水神社在岩沼(仙台搭東北本線約 20 分再轉車);水族館與 Outlet 同在仙台港,順路一次走完。" }
      },
      {
