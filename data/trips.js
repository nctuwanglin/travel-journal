  ...
  "info": [
    {
      "title": "📋 行程待確認",
      "items": [
        "航班編號、台灣機場與其餘起降時間。1/10 16:00 已依確認記為函館起飛。",
        "1/2 北斗特急車次與座位，以及抵達札幌後的午餐與景點時間。",
        "1/5–1/8 租車公司、取還車門市、時間與費用；1/8 還車及市區散策順序待定。",
        "餐廳分店、預約及 2027 年初營業安排；耀い與昭和物産已補對應食記供核對。",
        "各景點 2027 年初開放安排、票價及纜車營運狀態；不沿用歷史行程的舊價格。"
      ]
    },
    {
      "title": "🗺️ 資料說明",
      "items": [
        "每日安排依本次提供內容建檔，未表示已完成訂位或營業時間查核。",
        "景點標記為概略位置，湖泊與街區採代表點；導航前請確認實際入口與停車場。",
        "已補 10 天示意行程圖、小提醒與景點／美食網誌；未提供的星等與預算仍待補。",
        "網誌於 2026/9/8 核對主題與連結，作為遊記參考；查核日期不代表 2027 年營業、票價或訂位已確認。夏季、舊制與參考分店已另註明。"
      ]
    }
  ],
