    ...
    "info": [
      {
        "title": "🚗 自駕注意",
        "items": [
          "Budget 高松站前店：10/11 10:00 取車，10/16 10:00 同店還車",
          "日本靠左行駛；台灣駕照持有人攜帶駕照正本、合規日文譯本及護照",
          "店址：高松市西之丸町 2-20；電話：087-851-6543；營業 08:00–19:00",
          "導航用 MAPCODE 或電話"
        ]
      },
      {
      ...
      },
      {
        ...
        "items": [
          ...
          "小豆島當日往返高松搭渡輪",
          "跨四縣自駕,單日移動距離較長",
          "10/9 領取香川 FIT 後搭機場巴士到高松市區；10/16 10:00 還車後改搭大眾交通。"
        ]
      }
    ],
    "notes": [
      "租車：Budget 高松站前店，10/11 10:00 至 10/16 10:00；還車前預留加油與辦理手續時間。",
      "小豆島為離島須搭渡輪,留意末班船時刻。",
