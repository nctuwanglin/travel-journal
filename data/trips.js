...
window.TRIPS = [
{
  ...
  "spots": [
    ...
    },
    {
      ...
      "desc": "札幌取車後、前往登別途中造訪；標記湖畔溫泉區概略位置。",
      "hours": "2027 年初營業／開放安排待確認",
      "ref": {
        "title": "支笏湖散策・山線鐵橋遊記",
    ...
    },
    {
      ...
      "desc": "1/6 抵達，於乃之風連住兩晚；標記洞爺湖溫泉街湖畔概略位置。",
      "hours": "2027 年初營業／開放安排待確認",
      "ref": {
    ...
    },
    {
      ...
      "desc": "洞爺湖開往函館途中造訪；標記大沼公園站附近概略位置。",
      "hours": "2027 年初營業／開放安排待確認",
      "ref": {
        "title": "Jimmy・大沼與道南遊記",
        "url": "https://jacid.pixnet.net/blog/posts/9577953442"
    ...
    },
    {
      ...
      "desc": "1/10 最後逛街，之後前往機場搭乘 16:00 班機。",
      "hours": "2027 年初營業／開放安排待確認",
      "ref": {
  ...
  "food": [
    {
      "name": "根室花丸",
      "area": "函館",
      "note": "1/1 晚餐；文章介紹 Kiralis 函館店，實際分店與元旦營業待確認。",
      "ref": {
    ...
    },
    {
      "name": "GARAKU 湯咖哩",
      "area": "札幌",
      "note": "1/2 午餐；文章為札幌站店，實際分店待確認；抵達時間與候位需一起考量。",
      "ref": {
    ...
    },
    {
      "name": "耀い",
      "area": "札幌",
      "note": "1/3 晚餐；查到大通 BISSE 的耀い KAGAYOI 蟹海鮮涮涮鍋食記，供核對店家；預約與套餐待確認。",
      "ref": {
    ...
    },
    {
      "name": "Toriton",
      "area": "札幌",
      "note": "1/4 晚餐；文章為札幌豐平店，實際分店待確認；保留候位時間。",
      "ref": {
    ...
    },
    {
      "name": "昭和物產食堂",
      "area": "支笏湖溫泉街",
      "note": "1/5 午餐；參考支笏湖溫泉街「昭和物産」食堂，2027 年初營業待確認。",
      "ref": {
    ...
    },
    {
      "name": "成吉思汗大黑屋",
      "area": "函館",
      "note": "1/8 晚餐；參考函館五稜郭店食記，實際分店與預約待確認。",
      "ref": {
    ...
    },
    {
      "name": "味彩鹽拉麵",
      "area": "函館",
      "note": "1/9 午餐；函館本店食記可配合五稜郭動線參考，實際分店待確認。",
      "ref": {
        "title": "美食探測咦・味彩函館本店",
    ...
    },
    {
      "name": "一文字拉麵",
      "area": "函館",
      "note": "1/9 晚餐；參考湯之川的函館本店食記，實際分店待確認。",
      "ref": {
        "title": "瑪格・一文字函館本店",
    ...
    },
    {
      "name": "函館朝市",
      "area": "函館站周邊",
      "note": "1/10 早餐；先看菜單與價格再點餐，實際店家待確認。",
      "ref": {
  ...
  "info": [
    {
      "title": "🚗 自駕注意",
      "items": [
        "1/5 札幌取車、1/8 函館還車，出發前確認兩地門市與營業時間。",
        "取車時確認冬季輪胎、除雪工具及車輛操作方式。",
        "支笏湖、登別與洞爺湖間移動預留雪況時間，盡量在天亮時行駛。",
        "1/8 回函館先掌握還車期限，預留加油與手續時間，再安排市區散策。"
      ]
    },
    {
      "title": "📅 提前預約",
      "items": [
        "1/2 北斗特急為全車指定席，先選好車次與座位，再銜接札幌午餐。",
        "耀い與成吉思汗大黑屋先確認分店、可預約時段與用餐人數。",
        "想參加白色戀人餅乾製作或啤酒博物館導覽，先確認可預約日期。",
        "第一瀧本館與乃之風的晚餐時段，最好在入住前一併確認。"
      ]
    },
    {
      "title": "🍜 北海道必吃",
      "items": [
        "函館：朝市海鮮早餐、味彩與一文字鹽拉麵。",
        "札幌：GARAKU 湯咖哩、Toriton 迴轉壽司。",
        "根室花丸壽司、耀い蟹海鮮涮涮鍋與大黑屋成吉思汗烤羊肉。",
        "人氣餐廳預留候位時間，元旦前後先確認分店營業。"
      ]
    },
    {
      "title": "♨️ 溫泉住宿",
      "items": [
        "登別住第一瀧本館；洞爺湖連住兩晚 TOYA 乃之風。",
        "1/5–1/7 晚餐安排在飯店，外出行程留好回館用餐時間。",
        "1/6–1/8 安排飯店早餐，出發前確認早餐與退房時間。",
        "湖畔散步與泡湯可以穿插安排，風雪較大時多留飯店休息。"
      ]
    },
    {
      "title": "🌨️ 行程提醒",
      "items": [
        "函館山與有珠山纜車出發前查看當日運行與末班，強風停駛時保留替代安排。",
        "1/4 是週一，札幌啤酒博物館一般導覽原則上休止；自由見學與導覽分開確認。",
        "尼克斯海洋公園先看當日表演表；昭和新山熊牧場確認冬季最後入場時間。",
        "1/10 函館 16:00 起飛，朝市與購物後留足取行李、前往機場及報到時間。"
      ]
    }
  ],
  ...
  "weather": [
    ...
    "室內外溫差大，採可增減的分層穿搭；函館山夜景與湖邊散步加強防風。"
  ]
},
  {
    id: "tohoku-2026",
    ...
    stay: [
      { name: "仙台大都會飯店東口", nights: "全程 5 晚", rating: 4.2, note: "仙台站東口直結 / TEL +81-22-268-2233" }
    ],
    pass: {
      icon: "🚄", label: "交通票券",
      ...
      rows: [
        ...
        ["田澤湖 → 角館", "E6 こまち", "約 13 分"],
        ["角館 → 仙台", "E6 + E5(經盛岡)", "約 95 分"],
        ["仙台 ↔ 一之關", "E5 やまびこ", "約 31 分"],
        ["一之關 ↔ 猊鼻溪", "大船渡線(在来線)", "約 35 分"],
        ["仙台 → 福島", "E5 やまびこ", "約 22 分"],
        ["福島 → 仙台", "E5 やまびこ", "約 27 分"],
        ["仙台 ↔ 松島海岸", "JR 仙石線", "約 40 分"]
      ]
    },

    days: [
      {
        day: 1, date: "8/21 (五)", theme: "✈ 抵達仙台 16:00",
        items: [
          { time: "16:00", text: "星宇航空抵達仙台機場(SDJ),搭機場快線至仙台站(約 25 分,¥660)辦理入住" },
          { time: "晚餐", text: "善治郎牛舌(仙台站牛舌通名店)" },
          { time: "逛", text: "友都八喜(LOPIA)、仙台商店街(3COINS、扭蛋)" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "info", title: "小提醒", text: "傍晚抵達行程別排太滿。善治郎用餐時段常排隊,可先取號再逛商店街。" }
      },
      {
        day: 2, date: "8/22 (六)", theme: "🚤 岩手一日 — 猊鼻溪 + 麵包超人博物館",
        items: [
          { time: "早餐", text: "仙台朝市(仙台站西口步行約 5 分)" },
          { time: "09:35", text: "仙台站搭新幹線(やまびこ)→ 一之關站(10:06)" },
          { time: "10:16", text: "一之關站轉搭一般列車(大船渡線)→ 猊鼻溪站(10:51)" },
          { time: "11:00–12:30", text: "猊鼻溪舟遊(¥2,000)奇岩峭壁、船夫民謠吟唱、小鴨隨行" },
          { time: "13:12", text: "猊鼻溪站搭一般列車 → 一之關站(13:42)" },
          { time: "13:51", text: "一之關站搭新幹線 → 仙台站(14:23)" },
          { time: "下午", text: "麵包超人兒童博物館(10:00–17:00)角色麵包・舞台表演・戶外水上遊樂" },
          { time: "晚餐", text: "大魔王 GOLD 居酒屋" },
          { time: "逛", text: "仙台 PARCO(寶可夢中心、UNIQLO)" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "warn", title: "轉乘提醒", text: "車票已確認,一之關轉乘在来線僅 10 分鐘(10:06→10:16),回程猊鼻溪站也僅約 10 分接駁,建議提前抵達月台候車。猊鼻溪電話:+81-191-47-2341" }
      },
      {
        day: 3, date: "8/23 (日)", theme: "🚄 秋田一日 — 田澤湖・角館", couple: true,
        items: [
          { time: "09:05", text: "仙台站搭新幹線(經盛岡,可留意月台 E5/E6 連結・分離作業)→ 田澤湖站(10:25)" },
          { time: "10:45–12:16", text: "田澤湖環湖遊覽巴士(¥1,210)辰子像打卡・日本最深湖的湛藍湖水" },
          { time: "13:11", text: "田澤湖站搭新幹線 → 角館站(13:24)" },
          { time: "午餐", text: "櫻之里(角館・比內地雞親子丼)" },
          { time: "下午", text: "角館武家屋敷散策,江戶黑圍牆武士老街" },
          { time: "17:54", text: "角館站搭新幹線 → 仙台站(19:29)" },
          { time: "晚餐", text: "白雞舍拉麵" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "info", title: "小提醒", text: "本日車票已確認,田澤湖 → 角館僅 13 分鐘轉乘,先確認月台位置;角館午餐後約有 4 小時可散策,17:54 發車前建議提早 10 分抵達月台。" }
      },
      {
        day: 4, date: "8/24 (一)", theme: "🍑 福島・金蛇水神社 — Marusei 採水蜜桃",
        items: [
          { time: "09:00", text: "仙台站搭新幹線(やまびこ)→ 福島站(09:22)" },
          { time: "上午", text: "Marusei 果樹園採水蜜桃!8 月白桃盛產期,現採現吃超甜" },
          { time: "13:37", text: "福島站搭新幹線 → 仙台站(14:04)" },
          { time: "下午", text: "返仙台後順遊金蛇水神社(岩沼)祈財運・蛇紋石打卡" },
          { time: "晚餐", text: "燒肉仔虎(仙台牛名店)" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "warn", title: "務必提前預約", text: "車票已確認(仙台↔福島往返新幹線);Marusei 果樹園採果旺季務必預約,採果時間需配合 13:37 發車抓緊。返仙台後在岩沼站下車轉乘前往金蛇水神社,車程約 20 分再轉車。" }
      },
      {
        day: 5, date: "8/25 (二)", theme: "⛴ 仙台近郊 — 松島遊覽船・水族館・Outlet",
        items: [
          { time: "早上", text: "松島遊覽船(日本三景之一,環灣約 50 分;仙台搭 JR 仙石線約 40 分至松島海岸)" },
          { time: "下午", text: "仙台海洋森林水族館(9:00–17:30)沙丁魚旋風秀・企鵝大遊行(仙石線沿線,回程順道下車)" },
          { time: "傍晚", text: "三井 Outlet 仙台港(10:00–20:00)東北最大 Outlet,步行 10 分即達" },
          { time: "晚餐", text: "閣牛舌(牛たん料理 閣)" },
          { time: "住", text: "仙台大都會飯店東口" }
        ],
        tip: { type: "info", title: "小提醒", text: "松島遊覽船末班約 15:00–16:00,請留意時刻;仙台海洋森林水族館與三井 Outlet 都在仙台港(仙石線沿線),回程可順道一次走完。" }
      },
      {
        day: 6, date: "8/26 (三)", theme: "✈ 返回台北 17:20",
        items: [
          { time: "早餐", text: "仙台朝市最後巡禮" },
          { time: "上午", text: "仙台站周邊採買:萩の月・牛舌真空包・ずんだ餅・笹かまぼこ" },
          { time: "午餐", text: "一蘭拉麵" },
          { time: "14:30", text: "前往仙台機場(快線約 25 分),班機 17:20 起飛,滿載而歸!" }
        ],
        tip: { type: "info", title: "小提醒", text: "班機 17:20 起飛,建議 15:00 前抵達機場報到;伴手禮可前一天先買好。" }
      }
    ],
    ...
    spots: [
      ...
      },
      {
        ...
        desc: "福島縣是日本最著名的桃產區。Marusei(まるせい)果樹園可入園現採現吃,8 月正值白桃盛產,入口即化、香甜多汁,是台灣買不到的頂級滋味。B 級品(外觀不完美)一箱 ¥1,000–¥1,500,極為超值!可宅配回飯店。",
    ...
    budget: [
      ...
      { item: "住宿 5 晚(仙台大都會飯店東口)", cost: "約 ¥55,000–70,000" },
      { item: "每日餐食", cost: "約 ¥3,000–5,000" },
      { item: "景點門票(水族館/猊鼻溪/松島遊覽船/麵包超人)", cost: "約 ¥12,000" },
      { item: "總預算估算(不含機票)", cost: "約 ¥110,000–140,000", total: true }
    ],
    apps: [
      "Google Maps(離線地圖)",
    ...
    notes: [
      "Marusei 果樹園採果、麵包超人博物館旺季務必提前預約。",
      "猊鼻溪末班船約 15:00、松島遊覽船末班約 15:00–16:00,同日雙船班務必抓緊時刻表。",
      "新幹線指定席建議事先劃位,旺季座位較緊。"
    ]
  },
...

  {
    ...
    "mapZoom": 8,
    "mapArt": "img/shikoku-2026-v2.png",
    "flight": {
      "airline": "中華航空 China Airlines",
    ...
    "spots": [
      ...
      },
      {
        ...
        "desc": "位於桂濱海邊的小型水族館，可近距離觀察海洋動物；餵食與互動體驗依當日安排。可與桂濱散步、海之露台午餐一起規劃。",
        "ref": {
          "title": "許傑・桂濱水族館參觀攻略",
      ...
      },
      {
        ...
        "ref": {
          "title": "Tabirai・高知麵包超人博物館交通",
          "url": "https://tc.tabirai.net/sightseeing/article/kochi-anpanman-museum-access/"
        }
      },
      {
        "name": "鳴門渦潮",
    ...
    "food": [
      {
        ...
        "note": "栗林公園旁自助烏龍",
        "ref": {
          "title": "周花花・讚岐烏龍麵上原屋本店,tabelog3.87分",
      ...
      },
      {
        ...
        "area": "松山・大街道",
        "note": "鍋燒烏龍麵；舊食記標示週日休息，10/11 晚餐請先確認營業。",
        "ref": {
      ...
      },
      {
        "name": "壽司郎 伊予松前店",
        "area": "愛媛・松前",
        "note": "10/12 下灘站之後的迴轉壽司晚餐，導航請指定伊予松前店。",
        "ref": {
      ...
      },
      {
        ...
        "area": "高知・桂濱",
        "note": "桂濱海之露台的海鮮、貝出汁拉麵與定食，安排 10/13 午餐。",
        "ref": {
    ...
    "info": [
      {
        "title": "🚗 自駕注意",
        "items": [
          "10/11 10:00 JR 高松站取車，10/16 JR 高松站還車",
          "日本靠左行駛；台灣駕照持有人攜帶駕照正本、合規日文譯本及護照",
          "高速 ETC 收費,景點多免費停車",
          "導航用 MAPCODE 或電話"
        ]
      },
    ...
    "notes": [
      "10/11 10:00 JR 高松站取車，10/16 還車；還車時刻依租約安排。",
      "小豆島為離島須搭渡輪,留意末班船時刻。",
      "人氣餐廳（一鶴、寄鳥味鳥、白樂天）建議避開尖峰或預留排隊時間。"
    ]
  },
